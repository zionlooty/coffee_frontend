...
const HomePage = () => {
  ...
  return (
    <>
      ...
      {/* Coffee Types */}
      <section className="w-full flex flex-wrap justify-center gap-6 sm:gap-10 md:gap-20 mb-10 px-4 max-w-7xl mx-auto">
        {[
          ...
          <div key={item.label} className="flex flex-col items-center justify-center w-1/2 sm:w-1/4 mb-6">
            <img src={item.img} alt={item.label} className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28" />
            <h1 className="mt-2 text-gray-700 sm:text-white font-medium">{item.label}</h1>
          </div>
        ))}
      </section>
